...
9. Завантажити файли проекту: у bush-консолі прописати команди:
 ...
 10. Перейти у вкладку **Web**, прогортати вниз до розділу **Code**:
...
11. У розділі **Virtualenv** вказати назву віртуального середовища.
12. Оновити сайт, натиснувши кнопку **Reload**.
13. Перейти за посиланням веб-додатку.
14. У випадку помилок запуску веб-застосунку, перейти у розділ **Log files**, у пункті **Error log** перейти за посиланням; виправити вказані помилки, оновити сайт.
